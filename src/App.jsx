...
import { MessageSquare, Hash, Moon, Sun, LayoutGrid, Droplets, ChevronLeft, Terminal } from 'lucide-react';
...
const NavDock = () => {
  ...
  return (
    <div className="fixed bottom-8 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:right-auto z-50 w-auto md:w-full max-w-xl">
